...
export default function HomePage() {
  ...
  const features = [
    ...
    {
      icon: <Mic className="w-8 h-8 text-electric-purple" />,
      title: "Voice Interaction",
      description: "Natural voice conversations in English and Hindi for a more personal experience."
    },
    {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white overflow-hidden">
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center px-4 pt-20">
        ...
        >
          ...
          >
            Your multilingual AI mentor to help you plan careers, upskill smartly, and access curated growth paths. 
