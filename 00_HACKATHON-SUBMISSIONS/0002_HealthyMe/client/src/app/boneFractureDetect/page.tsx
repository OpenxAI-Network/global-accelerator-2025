...
import { TermsAndConditions } from '../register-record/components/TermsAndConditions';
...
const  page = () => {
  ...
  const [filepath, setFilepath] = useState("https://www.nih.gov/sites/default/files/styles/floated_media_breakpoint-medium/public/news-events/research-matters/2015/20150928-bone_0.jpg?itok=f9veaJGD&timestamp=1443205615");
  ...
  return (
    ...
    <div className='flex flex-col items-center  mr-20'>
      ...
      <h1 className='text-3xl font-bold z-50 relative'>Our AI Model
...
{/* <h1 className='text-2xl text-bold text-white backdrop-blur-lg'>Determining </h1> */}
     ...
     />
     <div className=' backdrop-blur-md text-black font-bold'>

     <h1>Your Chances To Have Bone Fracture is</h1>
     <h1 className='text-2xl text-center'>{chance}</h1>
     </div>
     <button onClick={()=>{
       console.log("Click ON Pdf Running");
       let doc=generateMedicalReport({name,email,mobile,chance,filepath})
       router.push("/register-record")
...
{myformsection && 
    ...
    />
      ...
      <div className=' flex flex-col justify-center items-center gap-3'>
        <h2 className='backdrop-blur-lg bg-transparent rounded-md text-md font-bold'>Click On This Image To Upload MRI</h2>
