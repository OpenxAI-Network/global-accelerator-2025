...
export async function POST(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${PYTHON_BACKEND_URL}/regular_calendar/accept_invitation`, {
      method: 'POST',
      headers: {
    ...
    console.error('Error forwarding accept invitation request to Python backend:', error);
    return NextResponse.json(
      { 
